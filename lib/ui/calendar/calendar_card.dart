  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
        top: getTimeDifference(
            earliestClass, widget.startTime, widget.datePrefix),
        left: CalendarStyles.calendarTimeWidth +
            widget.dayOfWeek * calendarCardWidth,
        child: GestureDetector(
            ...
            child: Container(
                ...
                height: getTimeDifference(
                    widget.startTime, widget.endTime, widget.datePrefix),
