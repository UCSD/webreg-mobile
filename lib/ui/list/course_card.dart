...
class CourseCard extends StatelessWidget {
  ...
  Widget renderActionButtons() {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          IconButton(icon: Icon(Icons.autorenew, color: ColorPrimary)),
          IconButton(icon: Icon(Icons.delete, color: ColorPrimary)),
          IconButton(icon: Icon(Icons.add_circle, color: ColorPrimary)),
        ]
      )
    );
  }
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: <Widget>[
                                    Text('CSE 12', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), // TODO
                                    Text('Enrolled - Letter', style: TextStyle(color: ColorPrimary, fontSize: 12)), // TODO
                                  ],
                                ),
