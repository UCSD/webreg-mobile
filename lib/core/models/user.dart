...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
      ...
      waitlistedCourses: List<CourseData>.from(
          json['waitlistedCourses'].map((x) => CourseData.fromJson(x))),
      plannedCourses: List<CourseData>.from(
          json['plannedCourses'].map((x) => CourseData.fromJson(x))));
